    ...
    <div class="w-full p-4">
      <div class="flex flex-col gap-4">
        ...
        <div class="p-4 bg-white">
          ...
          <div class="mb-4">
            <el-upload action="#" :auto-upload="true" :show-file-list="false" :http-request="handleUploadRequest"
              :before-upload="beforeUpload" accept="image/*,.pdf" multiple>
          ...
          <div class="flex flex-wrap gap-4">
            <div v-for="file in fileList" :key="file.uid || file.name"
              ...
              <div
                class="w-10 h-10 flex items-center justify-center bg-gray-50 rounded shrink-0 overflow-hidden cursor-pointer hover:bg-gray-100 transition-colors"
                @click="handlePreview(file)">
                <img v-if="isImageUrl(file.url) && file.url" :src="file.url" class="w-full h-full object-cover"
                  @error="handleImageError" />
                <div v-else-if="isPdfUrl(file.url)"
        ...
        <div class="p-4 bg-white">
          ...
          <div class="flex gap-4 items-center">
            ...
            <el-button type="primary" class="!bg-blue-500 !border-blue-500 !px-8 !h-[36px]" @click="sendFeedback">
              发送
            </el-button>
          </div>
        </div>
        ...
        <div class="p-4 bg-white">
          ...
          <CommonTable :data="orderDetailList.rows" :columns="orderColumns" :total="orderDetailList.totalRows">
            <template #status="{ row }">
...
const isImageUrl = (url?: string): boolean => {
  ...
  const lowerUrl = url.toLowerCase().split('?')[0] // 去除查询参数
